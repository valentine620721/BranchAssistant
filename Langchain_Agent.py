...
def generate_tables_name(table_inform, msg):
    system = f'''
        ...
        List all Table Name to be queried and JOIN, not SQL, ex: table1, table2, ...
    '''
...
def generate_SQL(table_inform, msg):
    ...
    1. SELECT all Field Name in SQL.
    2. Only use Field Name in SQL.
    3. Parse the information as format 'Field Name | Metadata | Datatype'.
